...
export async function generateMetadata(props: {
  ...
  const getCategoryDescription = (slug: string) => {
    const descriptions = {
      candles:
        "Авторские соевые свечи ручной работы ищ натуральных материалов с уникальными ароматами. Долгое горение, экологичные материалы, уникальные композиции. Истории",
      diffusers:
      ...
      perfumes:
        "Уникальные духи ручной работы с индивидуальными нотами. Стойкие композиции, прекрасный аромат",
    };
    return (
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: currentCategory.image || "og.jpg",
          width: 1200,
          height: 630,
